    ...
    <div>
      <main className="m-4 sm:flex sm:flex-row sm:items-center">
        ...
        <section className="sm:mx-5">
          ...
          <button className="rounded-md bg-black px-4 py-2 font-bold text-yellow-300 ring-green-500 transition-all duration-300 sm:text-lg sm:hover:bg-yellow-300 sm:hover:text-black sm:focus:ring-2 sm:active:bg-yellow-500 lg:text-2xl dark:bg-yellow-300 dark:text-black">
            Visit Instagram
          </button>
        </section>
      </main>
